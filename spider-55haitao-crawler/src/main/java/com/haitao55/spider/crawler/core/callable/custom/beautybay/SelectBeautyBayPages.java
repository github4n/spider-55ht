 ...
 * @see SelectUrls
 */
public class SelectBeautyBayPages extends AbstractSelectUrls {
	...
	public void invoke(Context context) throws Exception {
		...
		for (int i = Integer.parseInt(startIndex); i <= totalPagesInt; i++) {
			String pageUrl = templateUrl.replaceAll(PLACEHOLDER, String.valueOf(i*Integer.parseInt(itemsPerPage)));
	...
	private String selectTemplateUrl(Context context) {
		...
		if(!StringUtils.containsIgnoreCase(templateUrl, "http://")){
			templateUrl="http://www.beautybay.com".concat(templateUrl);
		}
