...
public class BglowingSelectUrls extends SelectUrls{
	...
	public void invoke(Context context) throws Exception {
		...
		Elements es = docment.select("ul.products-grid li .product-image-area a.product-image");
		...
		logger.info("Bglowing item url:{} ,get items :{}", context.getUrl().getValue(), newUrlValues.size());
	}
}
