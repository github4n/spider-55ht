...
public class HqhairSkuBean implements Serializable {

	private static final long serialVersionUID = 6322038630708216522L;
	...
	public HqhairSkuBean() {
	}

	public HqhairSkuBean(String skuId) {
		super();
		this.skuId = skuId;
	}
