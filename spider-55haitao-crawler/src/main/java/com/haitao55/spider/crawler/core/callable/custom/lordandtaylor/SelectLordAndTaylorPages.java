...
* @version 1.0
 */
public class SelectLordAndTaylorPages extends AbstractSelectUrls {
	...
	public void invoke(Context context) throws Exception {
		...
		String templateUrl = context.getCurrentUrl().concat("?beginIndex={}");

		List<String> newUrlValues = new ArrayList<String>();
		for (int i = Integer.parseInt(startIndex); i <= totalPagesInt; i++) {
			String pageUrl = templateUrl.replaceAll(PLACEHOLDER, String.valueOf((i-1)*totals));
