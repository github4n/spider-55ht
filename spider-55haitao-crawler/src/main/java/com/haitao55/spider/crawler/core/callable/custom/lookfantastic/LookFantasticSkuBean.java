...
public class LookFantasticSkuBean implements Serializable{
	...
	public LookFantasticSkuBean(){}
	
	public LookFantasticSkuBean(String skuId) {
		super();
		this.skuId = skuId;
	}
	...
	public String toString() {
		return "LookFantasticSkuBean [sale=" + sale + ", orig=" + orig + ", unit=" + unit + ", save=" + save
				+ ", skuId=" + skuId + ", stockNum=" + stockNum + ", stockStatus=" + stockStatus + ", isSelf=" + isSelf
				+ ", url=" + url + ", brand=" + brand + ", title=" + title + ", cats=" + cats + ", breads=" + breads
