...
public class FeeluniqueCates extends SelectUrls{
	...
	public void invoke(Context context) throws Exception {
		...
		Elements es = doc.select("ul.subnav li ol.mega-columns .c a");
		...
		logger.info("Feelunique Cates url:{} ,get items :{}", context.getUrl().getValue(), newUrlValues.size());
