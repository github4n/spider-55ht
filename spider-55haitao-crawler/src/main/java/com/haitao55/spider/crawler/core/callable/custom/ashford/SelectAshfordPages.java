...
* Company: 55海淘
* @author zhaoxl 
* @date 2016年12月30日 下午5:01:46
* @version 1.0
 */
public class SelectAshfordPages extends AbstractSelectUrls {
	...
	public void invoke(Context context) throws Exception {
		...
		templateUrl = templateUrl.concat("?No={}&Nrpp="+itemsPerPage);
...
//		?No=0&Nrpp=40
	...
	private String selectTotalItems(Context context) {
		...
		if(StringUtils.isNotBlank(totalItems)){
			totalItems = StringUtils.replacePattern(totalItems, "[, 件商品]", "");
		}
		return totalItems;
	}
