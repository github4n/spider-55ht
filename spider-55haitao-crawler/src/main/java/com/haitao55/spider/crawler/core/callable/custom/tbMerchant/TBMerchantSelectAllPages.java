...
public class TBMerchantSelectAllPages extends SelectUrls{
	...
	public void invoke(Context context) throws Exception {
		...
		logger.info("TBMerchantSelectAllPages list url:{} ,get items :{}", context.getUrl().getValue(), newUrlValues.size());
