...
public class Hqhair extends AbstractSelect {
	private static String requestUrl = "http://www.hqhair.com/variations.json?productId=";
	...
	private static String domain = "www.hqhair.com";
	...
	public void invoke(Context context) {
		...
		Map<String, HqhairSkuBean> skuResult = new HqhairHandler().process(skuUrlsList);
		// sku
		List<LSelectionList> l_selection_list = new ArrayList<LSelectionList>();
		List<LStyleList> l_style_list = new ArrayList<LStyleList>();
		if (null != skuResult && skuResult.size() > 0) {
			for (Entry<String, HqhairSkuBean> entry : skuResult.entrySet()) {
				String skuId = entry.getKey();
				HqhairSkuBean skuBean = entry.getValue();
				// selectlist
