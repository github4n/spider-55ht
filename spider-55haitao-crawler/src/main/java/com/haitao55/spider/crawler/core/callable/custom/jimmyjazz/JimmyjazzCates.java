...
public class JimmyjazzCates extends SelectUrls{
	...
	public void invoke(Context context) throws Exception {
		...
		Elements es = doc.select("ul.primary-links .container a");
		...
		logger.info("Jimmyjazz Cates url:{} ,get items :{}", context.getUrl().getValue(), newUrlValues.size());
