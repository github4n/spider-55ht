...
public class HttpDownload {
    ...
    static {  
        if (System.getProperty("os.name") != null && System.getProperty("os.name").toLowerCase().contains("windows")) {  
            ...
            isWindows = false;  
            splash = "/";  
            root=getOutPutDir("/download");  
            System.out.println(root);
        }  
    }  
    
    private static String getOutPutDir(String path) {
		URL url = HttpDownload.class.getProtectionDomain().getCodeSource().getLocation();
...
//			websiteDir.mkdir();
//		}
		return itemsRootDir.getAbsolutePath();
	}
    ...
    public static void main(String[] args) {  
        String url="http://23.91.97.48:8001/o_exp/index?user=emarsys&pwd=30318e6405fb67b52692f8c2c81fcbd3";  
