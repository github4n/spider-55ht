 ...
 * @see SelectUrls
 */
public class SelectStoretsPages extends AbstractSelectUrls {
	...
	private String selectTotalPages(Context context) {
		...
		if(CollectionUtils.isNotEmpty(elementsTotalPages)){
			...
			String totalPagesTemp = StringUtils.substringBetween(totalPages, "p=", "&");
			if(StringUtils.isEmpty(totalPagesTemp)){
				totalPagesTemp = StringUtils.substringAfter(totalPages, "p=");
			}
