...
public class VitaminPlanetSelectUrls extends SelectUrls{
		...
		if (CollectionUtils.isNotEmpty(elements)) {
			...
			for (Element e : elements) {
				...
				if(currentURL.contains("http")){
					String catId = StringUtils.substringBetween(currentURL, "-pl-", ".aspx").trim();
					String pageUrl = "https://www.vitaminplanet.cn/Products/getProducts?fsSort=Best+Selling&fsViewType=list&fiPageNo=0&fsSearch=&fiCategoryId="+catId+"&fiBrandId=0&fiAttributeId=0";
