 ...
 * @see SelectPages
 */
public class SelectLordAndTaylorUrls extends AbstractSelectUrls {
	...
	String content = Crawler.create().timeOut(6000).url("http://www.lordandtaylor.com/sitemap/index.xml").header(getHeaders())
