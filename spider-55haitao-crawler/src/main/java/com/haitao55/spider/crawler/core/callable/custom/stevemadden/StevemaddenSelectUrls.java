...
public class StevemaddenSelectUrls extends SelectUrls{
	...
	public void invoke(Context context) throws Exception {
		...
		Elements es = docment.select("#grid-products .item_wrap .productImage a.mainImage");
...
//					}
		...
		logger.info("Stevemadden item url:{} ,get items :{}", context.getUrl().getValue(), newUrlValues.size());
	}
}
