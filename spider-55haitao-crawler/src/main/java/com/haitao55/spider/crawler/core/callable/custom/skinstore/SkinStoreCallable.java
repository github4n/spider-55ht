...
class SkinStoreCallable implements Callable<SkinStoreSkuBean> {
	private static final Logger logger = LoggerFactory.getLogger(Constants.LOGGER_NAME_CRAWLER);
	private static final String imgprefix = "http://s4.thcdn.com/";
	private Url skuUrl;

	public SkinStoreCallable(Url skuUrl) {
		this.skuUrl = skuUrl;
	}

	@Override
	public SkinStoreSkuBean call() {
		SkinStoreSkuBean skuBean = new SkinStoreSkuBean();
