 ...
 */
public class SportDirectTest extends AbstractSelect {

	private static final Logger logger = LoggerFactory.getLogger(Constants.LOGGER_NAME_CRAWLER);
	private static final String domain = "www.sportsdirect.com";

	public static void main(String[] args) throws Exception {
		SportDirectTest sdt = new SportDirectTest();
		Context context = new Context();
		context.setCurrentUrl("http://www.sportsdirect.com/nike-short-sleeve-prep-tee-mens-653254?colcode=65325402");
//		context.setCurrentUrl("http://www.sportsdirect.com/nike-academy-top-mens-621067?colcode=62106722");
		sdt.invoke(context);
	}
	...
	public void invoke(Context context) throws Exception {
		...
		Unirest.setProxy(new HttpHost("104.196.109.105", 3128));
		...
		if (StringUtils.isNotBlank(content)) {
			...
			String defaultColor = StringUtils.trimToEmpty(document.select("#dnn_ctr103511_ViewTemplate_ctl00_ctl09_colourName").text());
...
//					if("Green".equals(obj.getString("State"))){			//经过测试发现State为Red的时候页面也能添加购物车，故此有无库存判断还有待观察
//						sku.setStatus(1);
//						sku.setStock(0);
//					}
					sku.setStatus(1);
