 ...
 * @Description:
 * @author: zhoushuo
 * @date: 2016年11月16日 下午4:55:04
 */
public class RebeccaminkoffItemTest extends AbstractSelect {
	...
	public static void main(String[] args) throws Exception {
		RebeccaminkoffItemTest rit = new RebeccaminkoffItemTest();
		long start = System.currentTimeMillis();
		Context context = new Context();
		context.setCurrentUrl("http://www.rebeccaminkoff.com/moto-3-zip-crossbody-mushroom-r16?src=catalog");
//		context.setCurrentUrl("http://www.rebeccaminkoff.com/ananke-dress-forget-me-not-multi?src=catalog");
//		context.setCurrentUrl("http://www.rebeccaminkoff.com/mika-slipper?src=catalog");
//		context.setCurrentUrl("http://www.rebeccaminkoff.com/sicily-embroidered-foldover-clutch-1?src=catalog");
//		context.setCurrentUrl("http://www.rebeccaminkoff.com/small-darren-satchel-black?src=catalog");
//		context.setCurrentUrl("http://www.rebeccaminkoff.com/la-ny-tee-heather-grey?src=catalog");
//		context.setCurrentUrl("http://www.rebeccaminkoff.com/la-ny-tee-heather-grey?src=catalog");
		context.setCurrentUrl("http://www.rebeccaminkoff.com/4-zip-moto-camera-bag-tawny-port-f16-1?src=catalog");
		context.setCurrentUrl("https://www.nordstromrack.com/shop/Women/Shoes/Boots%20&%20Booties?page=28&sort=featured");
		rit.invoke(context);
...
//			}
			if (StringUtils.isNotBlank(skuString)) {
				...
				if(attributes == null)
					return;
				JSONArray colorsJson = attributes.getJSONObject("221").getJSONArray("options");
...
//					style.setStyle_switch_img(color.getSwitchImg());
					...
					// context.getUrl().getImages().put(color.getSkuids().get(0)
					// + "", styleImgs);
					l_style_list.add(style);
					num++;
				}
