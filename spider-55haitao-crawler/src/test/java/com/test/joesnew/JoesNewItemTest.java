 ...
 * @Description:
 * @author: zhoushuo
 * @date: 2016年11月25日 下午2:01:23
 */
public class JoesNewItemTest extends AbstractSelect {
	...
	public static void main(String[] args) throws Exception {
		JoesNewItemTest jn = new JoesNewItemTest();
		Context context = new Context();
		context.setCurrentUrl("https://www.joesnewbalanceoutlet.com/product/wt53856/wt53856pc");
		// context.setCurrentUrl("https://www.joesnewbalanceoutlet.com/product/w880-v4/w880sb4");
		context.setCurrentUrl("https://www.joesnewbalanceoutlet.com/product/wl574-pn/wl574pbl");
		// can not get skus
		context.setCurrentUrl("https://www.joesnewbalanceoutlet.com/product/kjrusgs-g/kjruspbg");
		context.setCurrentUrl("https://www.joesnewbalanceoutlet.com/product/n2050-368-1/n2050-368-1-blk");
		context.setCurrentUrl("https://www.joesnewbalanceoutlet.com/product/W575-V2/W575LI2");
		context.setCurrentUrl("https://www.joesnewbalanceoutlet.com/dailydeal");
		context.setUrl(new Url() {
			{
				setValue(context.getCurrentUrl());
				setTask(new Task() {
					{
