...
public class SelectAllPageTest extends AbstractSelectUrls{
	...
	public static void main(String[] args) throws Exception {
		...
		Url url = new Url();
		url.setTask(task);
		url.setValue("http://www.ralphlauren.com/shop/index.jsp?categoryId=1760782&ab=global_women");
	...
	public void invoke(Context context) throws Exception {
		this.css = "div#left-nav ul.nav-items li a";
		this.attr = "abs:href";
		this.grade = 1;
		this.cssTemplateUrl = "div.grid-nav-links>a.next-page";
		this.cssTotalPages = "div.grid-nav-links form.pagination span.total-pages";
		this.replaceRegex = "pg=\\d+";
		this.replaceFormat = "pg={}";
		this.startIndex = "1";
