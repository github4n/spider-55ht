 		...
 		<div class="main-inner">
  			<div class="inner-box">
            		<div class="nav-sub-bar">
                		<div class="nav-sub">
                        	<span class="current">添加数据字典项</span>
                         </div>
                	</div>
                	<div id="div">
           			</div>
  			  <div class="table-wrap">
               	  <div class="table-wrap-box">
               	 	<h2>添加数据字典项</h2>
                    <form action="${pageContext.request.contextPath}/dictionary/insertDictionary.action" name="insertDictionaryForm" id="insertDictionaryForm"  method="post">
                          <div class="form-model">
                                <ul id="ul-outter" style="height: 1001px;">
                                   <li>
                                   	  <label><span style="color: red">*</span>类别 :</label>
                                   	  <input type="text" name="type" id="type" class="input" style="width: 500px;" />
                                   	  <span id="div_type_err_info" class="name-pop"></span>
                                   </li>
                                   <li>
                                   	  <label><span style="color: red">*</span>名称 :</label>
                                   	  <input type="text" name="name" id="name" class="input" style="width: 500px;" />
