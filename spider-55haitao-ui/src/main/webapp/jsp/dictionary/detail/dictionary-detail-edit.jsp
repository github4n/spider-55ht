 		...
 		<div class="main-inner">
  			<div class="inner-box">
            		<div class="nav-sub-bar">
                		<div class="nav-sub">
                        	<span class="current">修改字典数据</span>
                         </div>
                	</div>
                	<div id="div">
           			</div>
  			  <div class="table-wrap">
               	  <div class="table-wrap-box">
               	 	<h2>修改字典数据</h2>
                    <form action="${pageContext.request.contextPath}/dictionary/editDictionaryDetail.action" name="editDictionaryForm" id="editDictionaryForm"  method="post">
                    		 <!-- 以下几个变量的值,只有在提交表单前的javascript中赋值,才合适 -->
                    		 <input type="hidden" id="dictionary" name="id" value="${dictionaryView.id}" />
                          <div class="form-model">
                          	...
                          	<li>
                                    ...
                                    <li>
                                   	  ...
                                   	  <input type="text" name="key" id="key" class="input" value="${dictionaryView.key }" style="width: 500px;" />
    							      <span id="div_key_err_info" class="name-pop"></span>
                                   </li>
                                   <li>
                                   	  <label><span style="color: red">*</span>值 :</label>
                                   	  <input type="text" name="value" id="value" class="input" value="${dictionaryView.value }" style="width: 500px;" />
    							      <span id="div_value_err_info" class="name-pop"></span>
                                   </li>
                                   </ul>
                                 <div class="submit-box">
                            		<input name="button" id="button" type="button" class="defult-btn" value="确 定" onclick="javascript:editDictionaryDetail();"/>
                           		 </div>
                          </div>
                    </form>
               	  </div>
