                                ...
                                <ul id="ul-outter" style="height: 1001px;">
                                   <li>
                                	  <label><span style="color: red">*</span>任务名称 :</label>
                                  	  <input type="text" name="name" id="taskName" value="${taskView.name}" class="input" style="width: 500px;" />
    								  <span id="div_taskName_err_info" class="name-pop"></span>  
                                   </li>
                                   <li>
                                   	  <label><span style="color: red">*</span>网站域名 :</label>
                                   	  <input type="text" name="domain" id="taskDomain" value="${taskView.domain}" class="input" style="width: 500px;" />
                                   	  <span id="div_taskDomain_err_info" class="name-pop"></span>  
                                   </li>
                                   <li>
                                   	  <label><span style="color: red">*</span>初始URL :</label>
                                   	  <input type="text" name="initUrl" id="taskInitUrl" value="${taskView.initUrl}" class="input" style="width: 500px;" />
                                   	  <span id="div_taskInitUrl_err_info" class="name-pop"></span>
                                   </li>
                                   <li>
                                   	  <label><span style="color: red">*</span>执行速率 :</label>
                                   	  <input type="text" name="ratio" id="taskRatio" value="${taskView.ratio}" class="input" style="width: 500px;" />
                                   	  <label style="width: 25px;">/10"</label>
    							      <span id="div_taskRatio_err_info" class="name-pop"></span>
                                   </li>
                                   <li>
                                   	  <label>任务权重 :</label>
                                   	  <input type="text" name="weight" id="taskWeight" value="${taskView.weight}" class="input" style="width: 500px;" />
                                   	  <span id="div_taskWeight_err_info" class="name-pop"></span>
                                   </li>
                                   <li>
                                	  <label>任务描述 :</label>
                                  	  <input type="text" name="description" id="taskDescription" value="${taskView.description}" class="input" style="width: 500px;" />
    								  <span id="div_taskDescription_err_info" class="name-pop"></span>
                                   </li>
                                   <li>
                                   	  <label>负责人员 :</label>
                                   	  <input type="text" name="master" id="taskMaster" value="${taskView.master}" class="input" style="width: 500px;" />
                                   	  <span id="div_taskMaster_err_info" class="name-pop"></span>
                                   </li>
                                   <li>
                                   	  <label>网站地区 :</label>
                                   	  <input type="text" name="siteRegion" id="taskSiteRegion" value="${taskView.siteRegion}" class="input" style="width: 500px;" />
                                   ...
                                   <li>
                                      ...
                                      <textarea name="config" id="taskConfig" rows="29" cols="99"><c:out value="${taskView.config}" escapeXml="true"/></textarea>
    							      <span id="div_taskConfig_err_info" class="name-pop"></span>
                                   </li>
                                </ul>
                                 <div class="submit-box">
                            		<input name="button" id="button" type="button" class="defult-btn" value="确 定" onclick="javascript:editTask();"/>
                           		 </div>
                          </div>
                    </form>
               	  </div>
