...
<script type="text/javascript" src="<%=basePath%>js/proxy/proxy-create.js"></script>
 		...
 		<div class="main-inner">
  			<div class="inner-box">
            		<div class="nav-sub-bar">
                		<div class="nav-sub">
                        	<span class="current">添加代理ip</span>
                         </div>
                	</div>
                	<div id="div">
           			</div>
  			  <div class="table-wrap">
               	  <div class="table-wrap-box">
               	 	<h2>添加代理ip</h2>
                    <form action="${pageContext.request.contextPath}/proxy/insertProxy.action" name="insertProxyForm" id="insertProxyForm"  method="post">
                                   ...
                                   <li>
                                	  ...
                                	  <select id="regionId" name="regionId" class="input" style="width: 500px;">
									      <c:forEach var="proxyRegion" items="${proxyRegionList}"> 
									        <option value="${proxyRegion.key}">${proxyRegion.value}</option>
									      </c:forEach>
									  </select>
...
<!--                                    	  <input type="text" name="regionName" id="regionName" class="input" style="width: 500px;" /> -->
<%--                                    	  <span id="div_regionName_err_info" class="name-pop"></span>   --%>
<!--                                    </li> -->
                                   <li>
                                   	  <label><span style="color: red">*</span>代理ip :</label>
                                   	  <input type="text" name="ip" id="ip" class="input" style="width: 500px;" />
                                   	  <span id="div_ip_err_info" class="name-pop"></span>
                                   </li>
                                   <li>
                                   	  <label><span style="color: red">*</span>端口 :</label>
                                   	  <input type="text" name="port" id="port" class="input" style="width: 500px;" />
    							      <span id="div_port_err_info" class="name-pop"></span>
                                   </li>
                                 <div class="submit-box">
                            		<input name="button" id="button" type="button" class="defult-btn" value="确 定" onclick="javascrt:insertProxy();"/>
                           		 </div>
                          </div>
                    </form>
               	  </div>
