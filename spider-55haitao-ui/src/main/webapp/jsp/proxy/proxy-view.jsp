  			...
  			<div class="inner-box">
  			  ...
  			  <div class="table-wrap">
               	  <div class="table-wrap-box">
               	 	<h2>修改代理ip</h2>
<!--                     <form action="editProxy.action" name="editProxyForm" id="editProxyForm"  method="post"> -->
                          ...
                          <div class="form-model">
                          	<ul id="ul-outter" style="height: 201px;">
                                <li>
                                	  ...
                                	  <select id="regionId" name="regionId" class="input" style="width: 500px;" readOnly="true">
...
<%--                                    	  <input type="text" name="regionName" id="regionName" value="${proxyView.regionName}" readOnly="true" class="input" style="width: 500px;" /> --%>
<!--                                    	  <span id="div_regionName_err_info" class="name-pop"></span>   -->
<!--                                    </li> -->
                                   <li>
                                   	  <label><span style="color: red">*</span>代理ip :</label>
                                   	  <input type="text" name="ip" id="ip" value="${proxyView.ip}" class="input" readOnly="true" style="width: 500px;" />
                                   	  <span id="div_ip_err_info" class="name-pop"></span>
                                   </li>
                                   <li>
                                   	  <label><span style="color: red">*</span>端口 :</label>
                                   	  <input type="text" name="port" id="port" value="${proxyView.port}" class="input" readOnly="true" style="width: 500px;" />
